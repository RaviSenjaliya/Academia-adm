...
export default function Adminpage() {
  ...
  const handleDeleteClick = (row) => () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://academia-login.onrender.com/api/facultyregistrations/${row.row._id}`).then((r) => {
  ...
  useEffect(() => {
    axios.get('https://academia-login.onrender.com/api/facultyregistrations').then((r) => {
