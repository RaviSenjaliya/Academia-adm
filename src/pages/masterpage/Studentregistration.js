...
export default function Studentregistration() {
  ...
  const handleDeleteClick = (row) => () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://academia-login.onrender.com/api/studentregistrations/${row.row._id}`).then((r) => {
  ...
  useEffect(() => {
    axios.get('https://academia-login.onrender.com/api/studentregistrations').then((r) => {
