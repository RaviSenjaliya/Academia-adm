...
const Syllabus = () => {
  ...
  const handleSubmit = (e) => {
    ...
    e.preventDefault();
    axios.post('https://academia-api-cu1m.onrender.com/api/subassignment', formdata).then((r) => {
      setEdit(r.data._id);
      refresh();
    });
  };
  ...
  const handleDriveSubmit = (e, index) => {
    e.preventDefault();
    axios.post('https://academia-api-cu1m.onrender.com/api/subdrive', Drivedata).then((r) => {
      DsetEdit(r.data._id);
      Drefresh();
    });
  };
  ...
  const handleNoticeSubmit = (e) => {
    e.preventDefault();
    axios.post('https://academia-api-cu1m.onrender.com/api/subnotice', Noticedata).then((r) => {
      NsetEdit(r.data._id);
      Nrefresh();
    });
  };
  ...
  const updateData = (e) => {
    axios.put(`https://academia-api-cu1m.onrender.com/api/subassignment/${edit}`, data).then((r) => {
      console.log(r.data);
      setEdit(r.data._id);
      refresh();
    });
  ...
  const DupdateData = (e) => {
    e.preventDefault();
    axios.put(`https://academia-api-cu1m.onrender.com/api/subdrive/${Dedit}`, Drivedata).then((r) => {
      DsetEdit(r.data._id);
      Drefresh();
    });
  };
  ...
  const NupdateData = (e) => {
    e.preventDefault();
    axios.put(`https://academia-api-cu1m.onrender.com/api/subnotice/${Nedit}`, Noticedata).then((r) => {
      console.log(r.data);
      NsetEdit(r.data._id);
      Nrefresh();
    });
  ...
  const handleDeleteClick = (row) => {
    if (window.confirm('Are you sure you want to delete?')) {
      axios.delete(`https://academia-api-cu1m.onrender.com/api/subassignment/${row.row._id}`).then(() => {
  ...
  const DhandleDeleteClick = (row) => {
    if (window.confirm('Are you sure you want to delete?')) {
      axios.delete(`https://academia-api-cu1m.onrender.com/api/subdrive/${row.row._id}`).then(() => {
  ...
  const NhandleDeleteClick = (row) => {
    if (window.confirm('Are you sure you want to delete?')) {
      axios.delete(`https://academia-api-cu1m.onrender.com/api/subnotice/${row.row._id}`).then(() => {
  ...
  const handleEditClick = (row) => {
    axios.get(`https://academia-api-cu1m.onrender.com/api/subassignment/${row.row._id}`).then((r) => {
      setEdit(row.row._id);
      setData({
  ...
  const DhandleEditClick = (row) => {
    axios.get(`https://academia-api-cu1m.onrender.com/api/subdrive/${row.row._id}`).then((r) => {
  ...
  const NhandleEditClick = (row) => {
    axios.get(`https://academia-api-cu1m.onrender.com/api/subnotice/${row.row._id}`).then((r) => {
